...
MonitorMapItemBkg::MonitorMapItemBkg(MapBackground *_bkg, QGraphicsItem *parent) : QGraphicsObject(parent),
    bkg(_bkg)
{
    setZValue(1);
...
//绘制
void MonitorMapItemBkg::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(widget);
...
QVariant MonitorMapItemBkg::itemChange(GraphicsItemChange change, const QVariant &value)
{
