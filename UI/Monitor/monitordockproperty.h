#ifndef MONITORDOCKPROPERTY_H
#define MONITORDOCKPROPERTY_H
...
class MonitorDockProperty : public QDockWidget
{
    Q_OBJECT
public:
    MonitorDockProperty(OneMap* _oneMap, QWidget *parent = nullptr);
    void initTabTable();
