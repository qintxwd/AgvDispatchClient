...
MonitorMapItemCubicBezier::MonitorMapItemCubicBezier(MonitorMapItemStation *_startStation, MonitorMapItemStation *_endStation, MapPath *_path, QGraphicsItem *parent) : QGraphicsObject(parent),
...
QRectF MonitorMapItemCubicBezier::boundingRect() const
{
...
QPainterPath MonitorMapItemCubicBezier::shape() const
{
    QPainterPath qpath;
...
void MonitorMapItemCubicBezier::my_update()
{
    P1 = QPointF(path->getP1x(),path->getP1y());
    P2 = QPointF(path->getP2x(),path->getP2y());
...
//void MonitorMapItemCubicBezier::mousePressEvent(QGraphicsSceneMouseEvent *event)
//{
...
//void MonitorMapItemCubicBezier::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
//{
//    if(isDragingP1){
//        P1 = event->pos();
//        path->setP1x(P1.x());
...
//void MonitorMapItemCubicBezier::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
//{
//    isDragingP1 = false;
//    isDragingP2 = false;
