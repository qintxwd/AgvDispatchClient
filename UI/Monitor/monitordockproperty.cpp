...
MonitorDockProperty::MonitorDockProperty(OneMap *_oneMap, QWidget *parent) : QDockWidget(parent),
    oneMap(_oneMap)
{
    setMaximumWidth(300);
    initTabTable();
...
void MonitorDockProperty::initTabTable()
{
...
void MonitorDockProperty::initTableContent()
{
    /////////point
...
//    //disable all edit
    ...
    point_nameInput->setEnabled(false);
    point_comboxType->setEnabled(false);
    point_xInput->setEnabled(false);
    ...
    path_nameInput->setEnabled(false);
    path_comboxType->setEnabled(false);
    path_xP1Input->setEnabled(false);
    path_yP1Input->setEnabled(false);
    ...
    bkg_yInput->setEnabled(false);
    bkg_widthInput->setEnabled(false);
    bkg_heightInput->setEnabled(false);
    block_nameInput->setEnabled(false);
}

//地图修改的属性，这边更新
void MonitorDockProperty::slot_propertyChanged(MapSpirit *_spirit)
{
    //TODO:
...
void MonitorDockProperty::slot_shownull()
{
    slot_showSpirit(nullptr);
}

void MonitorDockProperty::slot_showSpirit(MapSpirit *s)
{
    if(spirit == s) return ;
    spirit = s;
...
void MonitorDockProperty::showPoint()
{
    if(spirit==nullptr)return ;
    //清空原来的数据
...
void MonitorDockProperty::showPath()
{
    if(spirit==nullptr)return ;
    //清空原来的数据
...
void MonitorDockProperty::showFloor()
{
    //清空原来的数据
    if(spirit==nullptr)return ;
...
void MonitorDockProperty::showBkg()
{
    //清空原来的数据
    if(spirit==nullptr)return ;
...
void MonitorDockProperty::showBlock()
{
    //清空原来的数据
    if(spirit==nullptr)return ;
...
void MonitorDockProperty::slot_PointNameChanged(QString name)
{
    if(spirit == nullptr)return ;
    spirit->setName(name.toStdString());
    emit sig_propertyChanged(spirit);
}
void MonitorDockProperty::slot_PointTypeChanged(int _type)
{
    if(spirit == nullptr)return ;
...
void MonitorDockProperty::slot_PointXChanged(QString x)
{
    if(spirit == nullptr)return ;
...
void MonitorDockProperty::slot_PointRealYChanged(QString realy)
{
    if(spirit == nullptr)return ;
...
void MonitorDockProperty::slot_PointLabelYoffsetChanged(QString labelYoffset)
{
    if(spirit == nullptr)return ;
    (static_cast<MapPoint *>(spirit))->setLabelYoffset(labelYoffset.toInt());
    emit sig_propertyChanged(spirit);
}
void MonitorDockProperty::slot_PointMapChangeChanged(int mapchange)
{
    if(spirit == nullptr)return ;
...
void MonitorDockProperty::slot_PathNameChanged(QString name)
{
    if(spirit == nullptr)return ;
...
//void MonitorDockProperty::slot_PathDirectionChanged(int _directino)
//{
//    if(spirit == nullptr)return ;
...
void MonitorDockProperty::slot_PathTypeChanged(int _type)
{
    if(spirit == nullptr)return ;
    (static_cast<MapPath *>(spirit))->setPathType((MapPath::Map_Path_Type)_type);
    emit sig_propertyChanged(spirit);
}
void MonitorDockProperty::slot_PathP1XChanged(QString p1x)
{
    if(spirit == nullptr)return ;
    (static_cast<MapPath *>(spirit))->setP1x(p1x.toInt());
    emit sig_propertyChanged(spirit);
}
void MonitorDockProperty::slot_PathP1YChanged(QString p1y)
{
    if(spirit == nullptr)return ;
    (static_cast<MapPath *>(spirit))->setP1y(p1y.toInt());
    emit sig_propertyChanged(spirit);
}
void MonitorDockProperty::slot_PathP2XChanged(QString p2x)
{
    if(spirit == nullptr)return ;
    (static_cast<MapPath *>(spirit))->setP2x(p2x.toInt());
    emit sig_propertyChanged(spirit);
}
void MonitorDockProperty::slot_PathP2YChanged(QString p2y)
{
    if(spirit == nullptr)return ;
    (static_cast<MapPath *>(spirit))->setP2y(p2y.toInt());
    emit sig_propertyChanged(spirit);
}
void MonitorDockProperty::slot_LengthChanged(QString length)
{
    if(spirit == nullptr)return ;
...
void MonitorDockProperty::slot_BkgXChanged(QString x)
{
    if(spirit == nullptr)return ;
    (static_cast<MapBackground *>(spirit))->setX(x.toInt());
    emit sig_propertyChanged(spirit);
}
void MonitorDockProperty::slot_BkgYChanged(QString y)
{
    if(spirit == nullptr)return ;
    (static_cast<MapBackground *>(spirit))->setY(y.toInt());
    emit sig_propertyChanged(spirit);
}
void MonitorDockProperty::slot_BkgWidthChanged(QString w)
{
    if(spirit == nullptr)return ;
    (static_cast<MapBackground *>(spirit))->setWidth(w.toInt());
    emit sig_propertyChanged(spirit);
}
void MonitorDockProperty::slot_BkgHeightChanged(QString h)
{
    if(spirit == nullptr)return ;
...
void MonitorDockProperty::slot_BlockNameChanged(QString name)
{
    if(spirit == nullptr)return ;
